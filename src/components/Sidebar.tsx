  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 flex flex-col h-screen shrink-0">
      ...
      <div className="p-4 border-t border-gray-200 space-y-1">
         ...
         <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium text-gray-500 hover:bg-gray-50 hover:text-gray-900 transition-colors">
